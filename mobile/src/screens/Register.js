...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { fontSize: 16, color: '#64748b', marginTop: 4, fontWeight: '500' },
  formCard: {
    marginHorizontal: 16, backgroundColor: '#fff', borderRadius: 24, padding: 20,
    borderWidth: 1, borderColor: colors.border || '#f1f5f9',
    elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.05, shadowRadius: 5,
  },
  sectionTitle: { fontSize: 16, fontWeight: '800', color: '#0f172a', marginTop: 24, marginBottom: 16, borderBottomWidth: 1, borderBottomColor: '#e2e8f0', paddingBottom: 8 },
  ...
  inputWrapper: {
    ...
    borderRadius: 14, borderWidth: 1, borderColor: '#e2e8f0', paddingHorizontal: 14, height: 52,
  },
  inputWrapperActive: { borderColor: colors.primary, backgroundColor: '#f0f9ff' },
  inputIcon: { marginRight: 10 },
  input: { flex: 1, color: '#1e293b', fontSize: 14, fontWeight: '600' },
  selectText: { flex: 1, fontSize: 14, color: '#94a3b8', fontWeight: '600' },
  selectTextActive: { color: '#1e293b' },
  servicesGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  serviceChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, backgroundColor: '#f1f5f9', borderWidth: 1, borderColor: '#e2e8f0' },
  serviceChipActive: { backgroundColor: colors.primary, borderColor: colors.primary },
  serviceText: { fontSize: 13, fontWeight: '600', color: '#64748b' },
  serviceTextActive: { color: '#fff' },
  uploadBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f8fafc', padding: 16, borderRadius: 14, borderWidth: 1, borderColor: '#e2e8f0', borderStyle: 'dashed', marginBottom: 12 },
  uploadTextContainer: { flex: 1, marginLeft: 16 },
  uploadTitle: { fontSize: 14, fontWeight: '700', color: '#1e293b' },
  uploadSubtitle: { fontSize: 12, color: '#94a3b8', marginTop: 2 },
  primaryBtn: {
    backgroundColor: colors.primary, height: 56, borderRadius: 16,
    flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 24, gap: 10, elevation: 2,
  },
  ...
  closeBtn: { padding: 4 },
  modalSearch: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f1f5f9', paddingHorizontal: 16, height: 52, borderRadius: 16, marginBottom: 20 },
  modalSearchInput: { flex: 1, marginLeft: 10, fontSize: 15, fontWeight: '600', color: '#1e293b' },
  libList: { paddingBottom: 40 },
  libItem: { flexDirection: 'row', alignItems: 'center', padding: 16, borderRadius: 16, marginBottom: 10, backgroundColor: '#fff', borderWidth: 1, borderColor: '#f1f5f9' },
  libItemActive: { borderColor: colors.primary, backgroundColor: '#f0f9ff' },
  libIcon: { width: 44, height: 44, borderRadius: 12, backgroundColor: '#f8fafc', justifyContent: 'center', alignItems: 'center', marginRight: 16 },
  libName: { fontSize: 15, fontWeight: '700', color: '#334155' },
  libNameActive: { color: colors.primary },
  libCity: { fontSize: 12, color: '#94a3b8', marginTop: 2, fontWeight: '500' },
