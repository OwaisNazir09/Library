        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
          <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-white w-full max-w-lg rounded-[3rem] p-12 shadow-2xl relative">
            ...
            <form onSubmit={handleSubmit(onAddTenant)} className="space-y-6">
              ...
              <button type="submit" className="w-full bg-[#044343] text-white font-black py-5 rounded-3xl mt-6 shadow-2xl shadow-teal-900/20 active:scale-95 transition-all">
                Create & Provision Library
              </button>
            </form>
          </motion.div>
        </div>
